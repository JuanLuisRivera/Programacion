...
int main(int argc, char** argv)
{
	...
	while (input[0] != 'q')
	{
        ...
        int intSum = inputValues.num1 + inputValues.num2 + inputValues.num3; //We define the variable "sum" as a datatype "int" and initialize it with the sum of the 3 integers in "inputValues"
        float average = (float) intSum / 3; //We define the variable "average" as a datatype "float" and initialize it as the result of the computation of the "intSum" divided by 3
